-- Keep the card-sale response compatible with Hermes ISO date parsing.
-- Card sales intentionally do not accept or verify an ad completion ID.
-- Toss mTLS authentication is reserved for the crystal-to-point exchange boundary.
...
BEGIN
  ...
  v_result := jsonb_build_object(
    ...
    'packAvailability', jsonb_build_object(
      ...
      'nextResetAt', ((current_date + 1)::timestamp AT TIME ZONE 'Asia/Seoul')
    ),
    'replayed', false
  );

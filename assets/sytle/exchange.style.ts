...
export const styles = StyleSheet.create({
  ...
  rarityBadge: { position: 'absolute', top: 4, right: 4, paddingHorizontal: 6, paddingVertical: 3, borderRadius: 7 },
  rarityText: { color: '#20242B', fontSize: 8, fontWeight: '800' },
  levelBadge: { position: 'absolute', left: 5, bottom: 5, backgroundColor: 'rgba(8, 12, 20, 0.84)', borderColor: '#EAC681', borderWidth: 1, borderRadius: 7, paddingHorizontal: 6, paddingVertical: 3 },
  level: { color: '#F5D390', fontSize: 9, fontWeight: '800' },

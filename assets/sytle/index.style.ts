...
export const styles = StyleSheet.create({
  ...
  collectionButton: { flexDirection: 'row', backgroundColor: '#1B3040', borderRadius: 16, padding: 17, marginTop: 20, alignItems: 'center', gap: 14, borderWidth: 1, borderColor: '#365269' },
  collectionMark: { color: '#72B6FF', fontSize: 26 },
  collectionArrow: { color: '#72B6FF', fontSize: 29, marginLeft: 5 },
